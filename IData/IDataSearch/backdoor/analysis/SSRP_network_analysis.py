...
class NetworkAnalysis(object):
    ...
    def __init__(self):
        ...
        self.words = [['氨基酸', '生物信息学分析', '游离氨基酸', '进化', '营养成分'], ['氨基酸', '进化', '蛋白质', '基因克隆', '生物信息学分析', '生物信息学'], ['酱油', '克隆', '氨基酸', '序列分析', '基因克隆', '脂肪酸', '支链氨基酸'], ['基因表达', '有机酸', '猪', '序列分析', '代谢工程'], ['代谢组学', '进化', '代谢', '进化', '合成']]
        # self.words = ['氨基酸', '生物信息学分析', '游离氨基酸', '进化', '营养成分', '氨基酸', '进化', '蛋白质', '基因克隆', '生物信息学分析', '生物信息学',
                      # '酱油', '克隆', '氨基酸', '序列分析', '基因克隆', '脂肪酸', '支链氨基酸', '基因表达', '有机酸', '猪', '序列分析', '代谢工程',
                      # '代谢组学', '进化', '代谢', '进化', '合成']

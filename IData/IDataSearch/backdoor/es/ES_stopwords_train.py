...
if __name__ == "__main__":
    st = StopwordsTrainES()
    file = '/Users/felix_zhao/Desktop/SSRP/词表集/标题测试集(1.8w).txt'
    file2 = '/Users/felix_zhao/Desktop/SSRP/词表集/泛化词表.txt'
    file3 = '/Users/felix_zhao/Desktop/SSRP/词表集/自定义分词词表.txt'
    txt = '/Users/felix_zhao/Desktop/SSRP/词表集/术语过滤词表.txt'
    # st.parse(file)
    # st.seg(file, txt)
    # st.tf_count(file, txt, 10)
    # st.filter_(file, txt, 100)
    # st.output(file, file2, txt, 100)
